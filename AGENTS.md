# AGENTS.md — OrchAI CLI Orchestrator Rules (The OrchAI Quartet)
# NOTE: This file is the Codex CLI counterpart of CLAUDE.md — keep both files in sync manually.
...
2. **Engine Specialist (Codex - Team Leader):** 
