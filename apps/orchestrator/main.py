...
from apps.orchestrator.api.routes.executions import router as executions_router
...
async def lifespan(app: FastAPI):
    logger.info("Starting AI Dev Team Platform orchestrator API (HTTP Only, CLI mode separate)")
    yield
