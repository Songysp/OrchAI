...
class SlackAdapter(ChatAdapter):
    """Placeholder Slack transport adapter.

    Future implementation should translate deliveries into Slack App API
    calls while keeping orchestration logic outside this class.
    """
